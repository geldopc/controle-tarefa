...
@Component({
    selector: "page-grupo-gestor-cliente",
    templateUrl: "./grupo-gestor-cliente.component.html",
    styleUrls: ["./grupo-gestor-cliente.component.scss"]
})
// tslint:disable-next-line:component-class-suffix
export class GrupoGestorClientePage implements OnInit {
    ...
    obterCliente() {
        ...
        load.present().then(() => {
            if (!GerenciadorSessao.sessao.usuario) {
                ...
                this.ocorrenciaProdutoService.obterClientesPorResponsavel(GerenciadorSessao.sessao.usuario.nrDocumento)
                    .then(resp => {
                        if (resp && resp.length) {
                            // this.clientes = resp;
                            // console.log("Tratar cliente", resp);
    ...
    obterGrupoGestor() {
        ...
        load.present().then(() => {
            this.grupoGestorService.obterTodosPorCliente(GerenciadorSessao.sessao.usuario.nrDocumento)
                .then(resp => {
